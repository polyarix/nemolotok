       ...
       <div class="tab-content pl-3 pt-2 card-body" id="nav-tabContent">
           <div class="tab-pane fade show active" id="nav-general" role="tabpanel" aria-labelledby="nav-general-tab">
               <div class="form-group">
                   ...
                   <input type="text"  name="name" placeholder="Title" value="{{$category->description->name or ''}}" class="form-control {{ !empty($errors->name) ? 'is-invalid' : '' }}">
           ...
           <div class="tab-pane fade" id="nav-data" role="tabpanel" aria-labelledby="nav-data-tab">
               <div class="form-group">
                   ...
                   <input type="text" id="slug" name="slug" value="@if(!empty($category)){{$category->slug->first()->slug or ""}}@endif"
               ...
               <div class="form-group">
                   ...
                   <select name="enabled" id="enabled" class="form-control {{ !empty($errors->enabled) ? 'is-invalid' : '' }}">
           ...
           <div class="tab-pane fade" id="nav-relations" role="tabpanel" aria-labelledby="nav-relations-tab">
               <div class="form-group">
                   <label for="multiple-select" class=" form-control-label">Родительская категория</label>
                       <div class="card-body">
                           <select name="categories[]" data-placeholder="Choose a Country..." class="form-control {{ !empty($errors->categories) ? 'is-invalid' : '' }}" tabindex="1">
                               <option value=""></option>
