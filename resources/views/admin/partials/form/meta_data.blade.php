<div class="form-group">
    ...
    <textarea name="description" class="form-control">{{$item->description->description or ''}}</textarea>
</div>
...
<div class="form-group">
    ...
    <textarea name="meta_description" class="form-control">{{$item->description->meta_title or ''}}</textarea>
</div>